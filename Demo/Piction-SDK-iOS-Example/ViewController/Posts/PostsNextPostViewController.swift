//
//  PostsNextPostViewController.swift
...
class PostsNextPostViewController: UIViewController {
    ...
    @IBAction func executeBtnPressed(_ sender: Any) {
        ...
        PictionSDK.posts.nextPost(uri: uriTextField.text ?? "", postId: Int(postIdTextField.text ?? "0") ?? 0,
            success: { response in
