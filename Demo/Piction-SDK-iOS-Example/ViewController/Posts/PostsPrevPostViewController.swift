//
//  PostsPrevPostViewController.swift
...
class PostsPrevPostViewController: UIViewController {
    ...
    @IBAction func executeBtnPressed(_ sender: Any) {
        ...
        PictionSDK.posts.prevPost(uri: uriTextField.text ?? "", postId: Int(postIdTextField.text ?? "0") ?? 0,
            success: { response in
