//
//  ProjectsRecommendedAddViewController.swift
...
class ProjectsRecommendedAddViewController: UIViewController {
    ...
    @IBAction func executeBtnPressed(_ sender: Any) {
        ...
        PictionSDK.projects.recommendedAdd(projectId: projectIdTextField.text ?? "",
            success: { response in
