//
//  RecommendationAllViewController.swift
...
class RecommendationAllViewController: UIViewController {
    ...
    @IBAction func executeBtnPressed(_ sender: Any) {
        ...
        PictionSDK.recommendation.all(size: Int(sizeTextField.text ?? "0") ?? 0,
            success: { response in
