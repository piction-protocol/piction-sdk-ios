//
//  RecommendationDeleteViewController.swift
...
class RecommendationDeleteViewController: UIViewController {
    ...
    @IBAction func executeBtnPressed(_ sender: Any) {
        ...
        PictionSDK.recommendation.delete(uri: uriTextField.text ?? "",
            success: { response in
